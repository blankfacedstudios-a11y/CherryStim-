...
import { BadgeDollarSign, Gem, Heart, Timer, Gift, Truck, CreditCard, Wand2, User } from "lucide-react";
    ...
    <main className="min-h-screen bg-dark-950 p-6 md:p-10">
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <section className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Card
            className="glass cursor-pointer p-6 transition hover:border-gold-500"
            onClick={() => router.push("/onboarding")}
            role="button"
          >
            <Gift className="mb-2 text-cherry-500" />
            <h2 className="mb-2 text-2xl font-semibold">Welcome Package</h2>
            <p className="text-white/70">Order your card, fragrance, and merch.</p>
          </Card>
          <Card
            className="glass cursor-pointer p-6 transition hover:border-gold-500"
            ...
            role="button"
          >
            <Truck className="mb-2 text-sky-400" />
            <h2 className="mb-2 text-2xl font-semibold">Order Tracking</h2>
          ...
          <Card
            ...
            role="button"
          >
            <Wand2 className="mb-2 text-purple-400" />
            <h2 className="mb-2 text-2xl font-semibold">AR Filters</h2>
            <p className="text-white/70">Face filters for streams and FaceTime.</p>
          </Card>
          <Card
            className="glass cursor-pointer p-6 transition hover:border-gold-500"
            ...
            role="button"
          >
            <User className="mb-2 text-gold-500" />
            <h2 className="mb-2 text-2xl font-semibold">My Profile</h2>
            <p className="text-white/70">Photos, rating, and account settings.</p>
          </Card>
        </section>
      </div>
    </main>
